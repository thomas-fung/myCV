...
tribble(
  ...
  "01/2022", NA, "Seniro Lecturer in Statistics", "School of Mathematical and Physical Sciences, Macquarie University",
...
tribble(
  ~Start, ~End, ~Position, ~ uni, 
  "11/2022", NA, "Deputy Course Director for BSc", NA, 
  "03/2022", NA, "Vice-President", "SSA", 
  "01/2022", NA, "Teaching Lead in Statistics", NA, 
  "03/2020", "03/2022", "President", "SSA", 
  "12/2019", NA, "Board of Directors Ordinary Members", "The Asian Regional Section of The International Association for Statistical Computing (IASC-ARS)",
...
pub <- scholar::get_publications("eworc5YAAAAJ") %>% 
  ...
  add_row(title = "Takeaway alcohol sales and violent crime: the implications of extended trading hours
", author = "JJJ Wang, T Fung, S Pynton", 
journal = "Crime and Justice Bulletin", number = "No. 247",
cites = 2, year = 2022, cid = NA, pubid = NA) %>% 
...
tribble(
  ...
  2023, "December", "Australian Statistical Conference", "Sydney", "Secretary of the Local Organising Committee", TRUE, 
  2023, "December", "IASC-ARS Conference", "Sydney",  "Chair of the Local Organising Committee and a member of the Scientific Program Committee", TRUE, 
  2022, "Februry", "IASC-ARS 2022", "Kyoto", "Scientific Program Committee", TRUE, 
