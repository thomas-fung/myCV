...
tribble(
  ...
  "05/2019", NA, "Teaching Lead in Statistics", "MQ",
...
tribble(
  ...
  "2010 (4 weeks)",
  "Unit Convenor", "Graphics, Multivariate Methods and Data Mining (STAT302)",
  "2010 (12 weeks)"
  ) %>% 
...
# Other presentations since `r (year_cutoff = 2015)`
